...
public class PileTest {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        System.out.println("----Test Write et Read----");
        ...
        System.out.println(pileTest.readObj());
        System.out.println(pileTest);

        if(pileTest.readObj().toString().equals(pileTest.toString())){
            System.out.println("Fonction write et read() OK");
        }
